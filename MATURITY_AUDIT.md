...
| `cargo test --all-targets` | PASS, 282 tests (161 library, 36 LSP binary, 14 frontend robustness, 71 runtime outcome) |
| Serez test runner | PASS on **both** platforms, 474 files/groups each; 0 failed; 0 skipped. `run_tests.sh` had been executing 306 of them — see the parity row below. |
