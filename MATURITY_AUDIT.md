...
| `cargo test --all-targets` | PASS, 302 tests (170 library, 36 LSP binary, 15 frontend robustness, 75 runtime outcome, 2 diagnostic codes, 4 filesystem reach) |
