...
| `cargo test --all-targets` | PASS, 303 tests (170 library, 36 LSP binary, 16 frontend robustness, 75 runtime outcome, 2 diagnostic codes, 4 filesystem reach) |
| Serez test runner | PASS on **both** platforms, 485 files/groups each; 0 failed; 0 skipped. `run_tests.sh` had been executing 306 of them — see the parity row below. |
