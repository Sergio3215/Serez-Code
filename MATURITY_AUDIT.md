...
| Serez test runner | PASS on **both** platforms, 483 files/groups each; 0 failed; 0 skipped. `run_tests.sh` had been executing 306 of them — see the parity row below. |
