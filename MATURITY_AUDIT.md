...
| `cargo test --all-targets` | PASS, 245 tests (148 library, 33 LSP binary, 9 frontend robustness, 55 runtime outcome) |
...
Still to write: `syntax.md`, `types.md`, `operators.md`, `scopes.md` and
`modules.md`. `cli.md`, `compatibility.md` and `values.md` are now written.
